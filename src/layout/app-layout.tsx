...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'it-manager', 'system-administrator', 'developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Servers', path: '/servers', entity: 'server', service: AccessServiceEnum.PROJECT, icon: FiServer },
