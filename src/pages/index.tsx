  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Blockerry - Simplifying server installations. Whether it's Wordpress or other tools, just fill out a form and we handle the backend processing in minutes. No technical expertise needed."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZXJ2ZXJzfGVufDB8fHx8MTY5OTk1MDE4Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tvick?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Taylor Vick`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Blockerry - Simplifying server installations. Whether it's Wordpress or other tools, just fill out a form and we handle the backend processing in minutes. No technical expertise needed.`}
            </Text>
            <Box
