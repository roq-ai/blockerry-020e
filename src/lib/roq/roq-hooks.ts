...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServerFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.server.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServerCount<T extends Prisma.serverCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.serverCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useServerCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.server.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServerFindManyWithCount<
  T extends Prisma.serverFindManyArgs,
  R extends { data: GetFindResult<Prisma.$serverPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.serverFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServerFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.server.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useServerFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useServerFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.server.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
